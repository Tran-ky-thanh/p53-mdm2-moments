...
RESULTS = [
 ...
 dict(sid="r10", num="4.9", fig="fig_step9_directional.png", fign=13,
   ...
   caption="(A) lagged cross-correlation and (B) lagged distance correlation of the detrended p53/MDM2 mRNA "
           ...
           "response trajectories from an explicit six-species simulation under full Nutlin; (E) a two-bar marginal-versus-partial "
           "comparison from a synthetic asynchronous Nutlin snapshot, with one observation per simulated cell; "
